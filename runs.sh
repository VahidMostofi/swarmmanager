...
# PredefinedSearch
# go run cmd/swarm-autoconfigure/main.go predefined_rtsi_95_300 PredefinedSearch

# Signle
go run cmd/swarm-autoconfigure/main.go after_predefined_rtsi_95_300 Single