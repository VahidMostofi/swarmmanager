...
go run cmd/swarm-autoconfigure/main.go cpu_mean_50 CPUUsageIncrease -property CPUUsageMean -threshold 60
go run cmd/swarm-autoconfigure/main.go cpu_mean_50 CPUUsageIncrease -property CPUUsageMean -threshold 70
go run cmd/swarm-autoconfigure/main.go cpu_mean_50 CPUUsageIncrease -property CPUUsageMean -threshold 80
go run cmd/swarm-autoconfigure/main.go cpu_mean_50 CPUUsageIncrease -property CPUUsageMean -threshold 90
