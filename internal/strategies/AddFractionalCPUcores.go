...
// Configure ....
func (c *AddFractionalCPUcores) Configure(info history.Information, currentState map[string]swarm.ServiceSpecs, servicesToMonitor []string) (map[string]swarm.ServiceSpecs, bool, error) {
	// isChanged := false
